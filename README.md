...
画布右上方“画布尺寸”可设置宽度（320–4000）和高度（240–3000），默认 800×600。尺寸决定舞台比例，实际显示自适应面板；默认按比例缩放站位；取消“按比例缩放舞者站位”则保留所有关键帧中相对左上角的画布坐标，越界时移至最近边界。尺寸及站位变更可一并撤销并随项目保存。光棒选色弹窗可切换“左右手同时”，一次设置双手颜色。
